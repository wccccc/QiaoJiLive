...
public class H264Stream extends VideoStream {
    ...
    private LinkedBlockingDeque<byte[]> bufferQueue = new LinkedBlockingDeque<>();//字节数组(帧)队列
    ...
    public H264Stream(RtspClient.SDPInfo sp) {
        Log.e("ComfdRtspClient",sp.toString());
        mSDPinfo = sp;
...
//            try {
//                mMeidaCodec = MediaCodec.createDecoderByType(MediaFormat.MIMETYPE_VIDEO_AVC);
        ...
        public void run() {
            ...
            while (!Thread.interrupted() && !isStop) {
                try {
                    ...
                    Log.e("ComfdRtspClient","framType:"+framType);
...
//                                    Log.e("ComfdRtspClient","INFO_OUTPUT_BUFFERS_CHANGED");
//                                    break;
//                                case MediaCodec.INFO_OUTPUT_FORMAT_CHANGED:
//                                    Log.e("ComfdRtspClient","INFO_OUTPUT_FORMAT_CHANGED");
//                                    break;
//                                case MediaCodec.INFO_TRY_AGAIN_LATER:
//                                    Log.e("ComfdRtspClient","INFO_TRY_AGAIN_LATER");
//                                    break;
//                                default:
//                                    Log.e("ComfdRtspClient","default");
